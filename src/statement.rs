...
impl Statement {
  ...
  pub fn build_from_string(statement_string:&String, parameter_count: types_internal::cass_size_t) -> Statement {unsafe{
  ...
  pub fn build_from_str(statement_string:&str, parameter_count: types_internal::cass_size_t) -> Statement {unsafe{
    let query_cstring = statement_string.to_c_str();
    let query = types_internal::cass_string_init(query_cstring.as_ptr());
    Statement{cass_statement:statement_internal::cass_statement_new(query,parameter_count),last_error:CassError::new(0)}
  }}
  ...
  pub fn bind_bytes(&mut self, index: types_internal::cass_size_t, value: CassBytes) -> &mut Statement {unsafe{
  ...
  pub fn bind_inet(&mut self, index: types_internal::cass_size_t, value: CassInet) -> &mut Statement {unsafe{
  ...
  pub fn bind_decimal(&mut self, index: types_internal::cass_size_t, value: CassDecimal) -> &mut Statement {unsafe{
  ...
  pub fn bind_custom(&mut self, index: types_internal::cass_size_t, size: types_internal::cass_size_t, output: *mut *mut u8) -> &mut Statement {unsafe{
    self.last_error = CassError{cass_error:statement_internal::cass_statement_bind_custom(self.cass_statement,index,size,output)};
    self
  }}

  pub fn bind_collection(&mut self, index: types_internal::cass_size_t, collection: CassCollection) -> &mut Statement {unsafe{
...
#[allow(unused_variables)]
  pub fn bind(&mut self, parameter_count: types_internal::cass_size_t) -> Statement {unsafe{
    Statement{cass_statement:statement_internal::cass_prepared_bind(self.cass_prepared),last_error:CassError::new(0)}
  }}
}
...
pub mod internal {
  ...
  #[link(name = "cassandra")]
  extern "C" {
    pub fn cass_statement_new(query: types_internal::CassString, parameter_count: types_internal::cass_size_t) -> *mut CassStatement;
    pub fn cass_statement_free(statement: *mut CassStatement);
    pub fn cass_statement_add_key_index(statement: *mut CassStatement, index: types_internal::cass_size_t) -> error_internal::CassError;
    ...
    pub fn cass_statement_bind_null(statement: *mut CassStatement, index: types_internal::cass_size_t) -> error_internal::CassError;
    pub fn cass_statement_bind_int32(statement: *mut CassStatement, index:types_internal:: cass_size_t, value: i32) -> error_internal::CassError;
    pub fn cass_statement_bind_int64(statement: *mut CassStatement, index: types_internal::cass_size_t, value: i64) -> error_internal::CassError;
    pub fn cass_statement_bind_float(statement: *mut CassStatement, index: types_internal::cass_size_t, value: f32) -> error_internal::CassError;
    pub fn cass_statement_bind_double(statement: *mut CassStatement, index: types_internal::cass_size_t, value: f64) -> error_internal::CassError;
    pub fn cass_statement_bind_bool(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::cass_bool_t) -> error_internal::CassError;
    pub fn cass_statement_bind_string(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::CassString) -> error_internal::CassError;
    pub fn cass_statement_bind_bytes(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::CassBytes) -> error_internal::CassError;
    pub fn cass_statement_bind_uuid(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::CassUuid) -> error_internal::CassError;
    pub fn cass_statement_bind_inet(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::CassInet) -> error_internal::CassError;
    pub fn cass_statement_bind_decimal(statement: *mut CassStatement, index: types_internal::cass_size_t, value: types_internal::CassDecimal) -> error_internal::CassError;
    pub fn cass_statement_bind_custom(statement: *mut CassStatement, index: types_internal::cass_size_t, size: types_internal::cass_size_t, output: *mut *mut u8) -> error_internal::CassError;
    pub fn cass_statement_bind_collection(statement: *mut CassStatement, index: types_internal::cass_size_t, collection: *const collection_internal::CassCollection) -> error_internal::CassError;
    ...
    pub fn cass_statement_bind_bool_by_name(statement: *mut CassStatement, name: *const ::libc::c_char, value: types_internal::cass_bool_t) -> error_internal::CassError;
